export default function EventCard1({ item }) {
  ...
  return (
    ...
    //     <div className="card_text">{item.oneLiner}</div>
    //   </div>
    // </div>
    <div className="relative inline-block w-1/2 flex-grow flex-shrink h-full overflow-hidden rounded select-none font-bold text-gray-900 text-xs">
