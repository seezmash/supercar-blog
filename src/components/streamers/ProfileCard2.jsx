...
export default function EventCard1({ item }) {
  ...
  return (
    <Link href={linkURL2} passHref>
      <div className="relative inline-block mr-4 mb-14 w-52 flex-grow select-none bg-whiteF borderF overflow-hidden cursor-pointer bg-gray-500F roundedF">
        <div className="relative top-0 bg-white left-0 w-full h-20 flex box_radius overflow-hidden flex-row-reverse roundedF">
        ...
        <div className="relative w-full bg-white">
          ...
          <div className="group_text_medium h-3 mb-6">{item.overview}</div>
        </div>
      </div>
    </Link>
  )
