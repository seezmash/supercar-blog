...
export default function EventCard1({ item }) {
  ...
  return (
    <Link href={linkURL2} passHref>
      <div className=" card_container relative mr-6 mb-4 w-48 flex-grow cursor-pointer select-none overflow-hidden pb-6">
        <div className="box_radius relative top-0 left-0 flex h-20 w-full flex-row-reverse overflow-hidden">
        ...
        <div className="relative w-full px-0 ">
          <div className="group_title_medium card_title mb-2 mt-2 truncate text-base font-bold">
            {item.title}
          </div>
