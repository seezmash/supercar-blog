...
export default function EventCard1({ item }) {
  ...
  return (
    <Link href={linkURL2} passHref>
      <div className="card_container relative mr-6 mb-10 inline-block h-80 w-64 flex-grow cursor-pointer select-none overflow-hidden bg-white">
        <div className="box_radius relative top-0 left-0 block h-40 w-full overflow-hidden">
          <img
        ...
        {/* ====================================================================== */}
        <div className="bg-whiteF h-28F relative mb-4 w-full px-0">
          <div className="group_title_medium h-16F card_title mt-1.5 mb-1.5 text-lg font-bold">
            {item.title}
          </div>
          <div className="event_date h-10F bg-green-50F text-green-800F box_radius table overflow-hidden bg-gray-100 px-1 py-0.5 text-xs font-semibold tracking-wide">
            Febuary 17
          </div>
