...
export default function EventCard1({ item }) {
  ...
  return (
    <Link href={linkURL2} passHref>
      <div className="border-tF pt-10F p-1F bg-whiteF roundedF relative mr-6 mb-10 inline-block h-80 w-64 flex-grow cursor-pointer select-none overflow-hidden rounded-md bg-white shadow">
        <div className="bg-whiteF box_radiusF relative top-0 left-0 block h-40 w-full overflow-hidden">
          <img
        ...
        {/* ====================================================================== */}
        <div className="bg-whiteF h-28F relative mb-4 w-full px-2">
          <div className="group_title_medium h-16F mt-1.5 mb-1.5 text-lg font-bold">
            {item.title}
          </div>
          <div className="h-10F bg-green-50F text-green-800F table overflow-hidden rounded bg-gray-100 px-1 py-0.5 text-xs font-semibold tracking-wide">
            Febuary 17
          </div>
