...
export default function EventCard1({ item }) {
  ...
  return (
    <Link href={linkURL2} passHref>
      <div className="card_container relative mr-6 mb-4 inline-block w-48 flex-grow cursor-pointer select-none overflow-hidden pb-2">
        <div className=" box_radius rounded-tF relative top-0 left-0 block h-28 w-full overflow-hidden">
          <img
        ...
        <div className="h-28F relative mb-4 w-full">
          <div className="group_title_medium h-16F card_title mt-1.5 mb-1.5 text-base font-bold">
            {item.title}
          </div>
