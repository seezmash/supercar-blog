...
const LargeBlogCard = ({ item }) => {
  ...
  return (
    <Link href={linkURL} passHref>
      <div className="flex-colF relative mr-6 mb-8 inline-block w-64 flex-shrink-0 flex-grow cursor-pointer select-none overflow-hidden rounded-md bg-white p-1 shadow">
        ...
        <div className="bg-whiteF box_radius relative w-full flex-grow py-3 px-2">
          <div className="blog_title_medium font_style bold_text_color text-lg font-bold leading-normal">
            {itemTitle}
          </div>
