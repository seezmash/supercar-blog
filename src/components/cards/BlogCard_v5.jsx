...
const LargeBlogCard = ({ item }) => {
  ...
  return (
    <Link href={linkURL} passHref>
      <div className="card_container box_radius borderF relative mr-6 mb-8 inline-block w-56 flex-shrink-0 flex-grow cursor-pointer select-none overflow-hidden bg-white pb-2 shadow">
